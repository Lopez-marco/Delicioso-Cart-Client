...
> {
  ...
  fetchLists() {
    fetch(`${APIURL}/shopping-list/all`, {
      method: "GET",
      headers: new Headers({
  ...
  handleShoppingListClick = (list: ListsInterface) => {
    ...
    console.log(
      this.state.shoppingListToDisplay,
      this.state.shoppingListNameToDisplay
    );
  };
  ...
  addList() {
    fetch(`${APIURL}/shopping-list/add-list`, {
      method: "POST",
      body: JSON.stringify({
  ...
  render() {
    ...
    return (
      <div id="shopping-list-component">
          ...
          >
            {this.state.lists.map((list) => (
              <Menu.Item
                ...
                onClick={(e) => this.handleShoppingListClick(list)}
              >
                {list.name}
              </Menu.Item>
            ))}
            ...
            <Menu.Item
              ...
              onClick={this.handleDisplayManage}
            >
              Manage Lists
            </Menu.Item>
          </Menu>
        ...
        {this.state.displayManageLists ? (
          <ManageLists lists={this.state.lists} fetchLists={this.fetchLists} />
        ) : this.state.displayShoppingList ? (
          <ShoppingList
            id={this.state.shoppingListToDisplay}
            listName={this.state.shoppingListNameToDisplay}
          />
        ) : (
